...
public class Realty {
	...
	public Realty(Long no, String title, LocalDateTime publishedDate, User user, RealtyType status, String province,boolean isPubished) {
		super();
		this.no = no;
		this.title = title;
	...
	public boolean getIsPubished() {
		return isPubished;
	}

	public void setPubished(boolean isPubished) {
		this.isPubished = isPubished;
	}
